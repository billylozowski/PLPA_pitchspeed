...
[Mahieu, Qannari & Jaillais (2023)](https://www.sciencedirect.com/science/article/abs/pii/S0169743923002368)


```{r extract random forest estimates}
...
```{r model variables, weights, and ICs}
...
```{r variable importance across models}
